...
namespace CoffeeBike\ErpNextBundle\Command;
...
class InvalidateSessionCommand extends Command
{
     ...
     * @var string
     */
    protected static $defaultName = 'coffee-bike:erp:invalidate-session';
    ...
    {
        $this->setDescription('Invalidates the current ERP REST Session.');
    }
